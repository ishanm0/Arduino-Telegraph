/*
 * Launch the serial monitor after running, in the bottom right
 * corner, next to the baud rate, click on the "No line ending"
 * dropdown and select "Newline". Then enter a message, such as
 * your name, and it will be translated into Morse Code!
 */
#include "telegraph.h"
